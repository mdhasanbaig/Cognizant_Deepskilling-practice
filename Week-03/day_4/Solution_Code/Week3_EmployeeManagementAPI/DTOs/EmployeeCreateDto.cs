...
{
    /// <summary>
    /// DTO used for POST /api/employees.
    /// Contains only the fields a client is allowed to supply when creating an employee.
    /// EmployeeId is intentionally absent — the database generates it.
    /// Department navigation object is absent — client supplies DepartmentId only.
    /// </summary>
